        ...
        <div className="m-content">
          <div className="m-content-inner" key={mobileCurrent}>
            ...
            <div className="m-bottom">
              ...
              <div className="m-bottom-cell">
                <AnimatedBtn href="https://wa.me/917594960023?text=Hi!%20I%20have%20an%20enquiry%20regarding%20Royal%20Enfield." bgColor="#f51b24" hoverColor="#111" target="_blank" style={{ height: '50px' }}>
                  Test Ride
                </AnimatedBtn>
              </div>
