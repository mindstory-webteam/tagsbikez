...
const locationData = {
  ...
  Kuriachira: {
    ...
    bannerSub: "TagsBikez Kuriachira makes the Royal Enfield buying and service process easier for riders in Kuriachira, Thrissur city, and nearby locations. As a trusted Royal Enfield dealer in Kuriachira, we help you explore motorcycles, compare models, book test rides, check finance options, choose genuine accessories, and plan your delivery. Whether you are buying your first Royal Enfield or upgrading to a new model, our team will guide you with clear information and no pressure. Visit our Royal Enfield showroom in Kuriachira and take the next step toward your ride with confidence.",
    features: [
      { icon: <ShieldCheck size={20} strokeWidth={1.6} color="#e8282b" />, title: "KURIACHIRA'S FINEST DEALER", desc: "Looking for a reliable Royal Enfield dealer in Kuriachira? TagsBikez Kuriachira helps riders explore the Royal Enfield range in a clear and comfortable way. Whether you need a motorcycle for daily travel, weekend rides, city use, or long-distance trips, our team will help you choose a model that fits your style, budget, and riding needs. Visit our Royal Enfield showroom in Kuriachira to check available models, colours, booking details, finance options, accessories, and delivery updates. We explain each step clearly, so you can make your decision without confusion." },
      { icon: <BadgeCheck size={20} strokeWidth={1.6} color="#e8282b" />, title: "AUTHORISED SERVICE", desc: "Your Royal Enfield needs regular care to stay smooth, safe, and ready for every ride. At TagsBikez Kuriachira, we guide riders with service support, maintenance advice, genuine spare parts enquiries, and expert assistance. Whether it is routine service, inspection, part replacement support, or general maintenance guidance, our team is here to help. Riders from Kuriachira, Thrissur city, and nearby areas can contact us to know the latest service availability and booking details." },
      { icon: <Wrench size={20} strokeWidth={1.6} color="#e8282b" />, title: "SMART FINANCING", desc: "Buying a Royal Enfield should be simple and stress-free. At our Royal Enfield showroom in Kuriachira, we help you understand model pricing, booking steps, EMI options, exchange support, and current offers. From your first enquiry to the final booking, our team keeps the process clear. You can compare models, understand payment options, and plan your purchase with confidence. Visit TagsBikez Kuriachira or contact us for finance guidance on your preferred Royal Enfield motorcycle." },
      { icon: <Clock size={20} strokeWidth={1.6} color="#e8282b" />, title: "PERFECT HANDOVER", desc: "Taking delivery of a new bike is always special. At TagsBikez Kuriachira, we make the delivery process clear and well-organised from the beginning. Our team helps with documentation, registration guidance, payment coordination, accessory fitting updates, and delivery scheduling. Before you ride your Royal Enfield home, we keep you informed about every important step. For riders in Kuriachira and nearby Thrissur locations, our focus is to make the handover smooth, clear, and memorable." },
    ],
