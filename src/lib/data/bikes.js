...
export const bikeData = [
  {
    ...
    colors: [
      { name: 'Factory Black', hex: '#111111', image: img.hunter350factoryBlack, price: '₹1,69,189' },
      { name: 'Graphite Grey', hex: '#555555', image: img.hunter350graphitegrey, price: '₹2,01,051' },
      { name: 'Dapper Grey', hex: '#666666', image: img.hunter350dappergrey, price: '₹2,01,051' },
      { name: 'Rio White', hex: '#eeeeee', image: img.hunter350riowhite, price: '₹2,01,051' },
      { name: 'London Red', hex: '#9B111E', image: img.hunter350londonred, price: '₹2,06,464' },
      { name: 'Rebel Blue', hex: '#1B4D89', image: img.hunter350rebelblue, price: '₹2,06,464' },
      { name: 'Tokyo Black', hex: '#1c1c1c', image: img.hunter350tokyoblack, price: '₹2,06,464' },
      { name: 'Tarmac Black', hex: '#222222', image: img.hunter350tarmacblack, price: '₹1,83,399' },
      { name: 'Moonshot White', hex: '#ffffff', image: img.hunter350moonshotwhite, price: '₹2,06,464' },
      { name: 'Mumbai Yellow', hex: '#FFD700', image: img.hunter350mumbaiyellow, price: '₹2,06,464' },
    ],
